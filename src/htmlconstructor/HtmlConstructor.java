...
//ARCHIVOS .HG__________________________________________________________________
            ...
            throws IOException
    {
        ...
        BufferedWriter escribir = new BufferedWriter(new FileWriter(ProyectScreen.title+".hg"));
...
//VISUALES PERMANENTES__________________________________________________________

    public static boolean vtnOpen=false;
    
    public static UserLog ingresar = new UserLog();
    public static User menu = new User();
    public static ProyectScreen proyecto = new ProyectScreen();
