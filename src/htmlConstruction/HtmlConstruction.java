...
public class HtmlConstruction implements Runnable{
    ...
    /**
     * construct a document whit a personalizated tittle
     * @param tittle 
     */
    public void DocumentConstruction(String doctitle)
    {
        
        this.docName=doctitle+".html";
        this.tittle=doctitle;
        run();
    }
...
//______________________________________________________________________________    
    ...
    /**
     * starts the head structure whit the default tittle
     * @throws IOException 
     */
            ...
            throws IOException
    {
        ...
        BufferedWriter escribir = new BufferedWriter(documento);
            ...
            escribir.write("    <title>"+this.tittle+"</title>");
            escribir.newLine();
            ...
            throws IOException
    {
        ...
        BufferedWriter escribir = new BufferedWriter(documento);
            ...
            escribir.write("<script src="+((char)34)+this.tittle+".js"+((char)34)+"></script>");
            escribir.newLine();
